...
let myPow=function(a, b, callback) {
  let recurtion = function(x,y){
  if (y!=1) return x*= recurtion(x, y-1) 
  else return x;
  };
  return callback(a, b, recurtion(a,b));
};
...
let notUniqStrings = ['monday','teusday', 'wednesday', 'thursday', 'friday', 'monday','monday','wednesday','thursday'];
